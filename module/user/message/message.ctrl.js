(function () {
    ...
    function messageCtrl($scope, $http, UserSrv, $modal, aPIInterFace, $q, $timeout) {
        ...
        vm.GetLocumMessageList = GetLocumMessageList;
        ...
        function GetLocumMessageList() {
            ...
            if (currentUser.userId != undefined && currentUser.userId != null && currentUser.userType == "2") {
                ...
                aPIInterFace.doServiceCall('Get', 'GetLocumMessageList', data).then(function (response) {
                    
                    if (response.Success) {
                        vm.jobDetails = response.Result;
                        LoaderStop();
                    }else {
        ...
        function sendMessage(message) {
            ...
            if (currentUser.userId != undefined && currentUser.userId != null && currentUser.userType == "2") {
                ...
                vm.messageResult.push({message:message,locumName:currentUser.userName, type:currentUser.userType });
