...
.directive('timepickerPop', function ($document, timepickerState) {
    return {
        ...
        template: "  <div class='input-group-btn' ng-class='{open:isOpen}'> "
            + "         <input type='text'  readonly='readonly'   data-toggle='dropdown' ng-click='toggle()' ng-model='inputTime' ng-disabled='disabledInt' time-format show-meridian='showMeridian' />"
            + "          <div class='dropdown-menu pull-right timepicker_wrap'> "
